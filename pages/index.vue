<template>
  <v-container fluid>
    <img class="homeImage "src="NA.png" />
    <v-row>
      <v-col xs1>
      </v-col>
      <v-col xs10>
        <v-text-field v-on:keyup.enter.native="submit" v-model="searchBar" label="Ethereum Network" hint="search for projects, topics, adresses, txIDs, ..." autofocus ></v-text-field>
      </v-col>
    </v-row>
  </v-container>
</template>
